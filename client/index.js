...
import ApolloClient, {HTTPFetchNetworkInterface} from 'apollo-client'; //make requests to GraphQL, store data etc...
...
const networkInterface = new NetworkInterface('/app/graphql')
